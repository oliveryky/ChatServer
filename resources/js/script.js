    ...
    join.addEventListener("click", function() {
        ...
        mySocket.onmessage = function(event) {
            ...
            if(temp.user == uName) {
                ...
                textUser.textContent = temp.user + ": ";
                textUser.style.marginBottom = '0px';
                textUser.style.marginLeft = '7px';
                textUser.style.fontSize = '12px';
                msg.appendChild(textUser);
            }

            let textMsg = document.createElement('p');
            textMsg.textContent =  temp.message;
            textMsg.setAttribute('id', 'p');
